...
Output_fasta_file = sys.argv[5] #Fasta file with the sequences for training (new_data/fasta_sequences_CTCF.pkl)
Output_act_file = sys.argv[6] #Act file with the sequences for training (new_data/tf_peaks_CTCF.pkl)
