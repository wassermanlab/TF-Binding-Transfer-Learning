...
#in tools function train_individual_TF_models uncomment freezing way 
ITNUMBER=$1
TRAIN_DATA_FOLDER=~/gnovakovskytmp/Unibind_project/Unibind_Oriol_new/TRAIN_DATA_50_FR_LAYERS
MODEL_WEIGHTS_FOLDER=~/gnovakovskytmp/Unibind_project/Unibind_Oriol_new/MODEL_WEIGHTS_50_FR_LAYERS
RESULTS_FOLDER=~/gnovakovskytmp/Unibind_project/Unibind_Oriol_new/RESULTS_50_SORTED_BN_FR_LAYERS
...
do
    ...
    #in train_individual_TF_models change the way of TL!
