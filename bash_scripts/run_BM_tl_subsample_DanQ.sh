...
INCLUDE_TARGET=$5
REAL=$6
TRAIN_DATA_FOLDER=~/gnovakovskytmp/Unibind_project/Unibind_Oriol_new/TRAIN_DATA_BM_SUBSAMPLE_R_DANQ_$REAL\_I_$INCLUDE_TARGET
MODEL_WEIGHTS_FOLDER=~/gnovakovskytmp/Unibind_project/Unibind_Oriol_new/MODEL_WEIGHTS_BM_SUBSAMPLE_R_DANQ_$REAL\_I_$INCLUDE_TARGET
RESULTS_FOLDER=~/gnovakovskytmp/Unibind_project/Unibind_Oriol_new/RESULTS_BM_SUBSAMPLE_R_DANQ_$REAL\_I_$INCLUDE_TARGET
